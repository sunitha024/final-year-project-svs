...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">7th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $seva ?></h5></td>
               <td><h5><?php echo $sevb ?></h5></td>
               <td><h5><?php echo $sevc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $sevd ?></h5></td>
               <td><h5><?php echo $seve ?></h5></td>
               <td><h5><?php echo $sevf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $sevg ?></h5></td>
               <td><h5><?php echo $sevh ?></h5></td>
               <td><h5><?php echo $sevi ?></h5></td>
               <td><h5><?php echo $sevj ?></h5></td>
               <td><h5><?php echo $sevl ?></h5></td>


               <td><a href="update.php?sevA=<?php echo $seva ?>"><button class="btn btn-primary text-xl p-2">EDIT</button></a></td>
               <td><a href="delete.php?sevA=<?php echo $seva ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
