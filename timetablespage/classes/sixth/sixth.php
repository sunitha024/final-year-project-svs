...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">6th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $sixa ?></h5></td>
               <td><h5><?php echo $sixb ?></h5></td>
               <td><h5><?php echo $sixc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $sixd ?></h5></td>
               <td><h5><?php echo $sixe ?></h5></td>
               <td><h5><?php echo $sixf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $sixg ?></h5></td>
               ...
               <td><a href="delete.php?sixA=<?php echo $sixa ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
