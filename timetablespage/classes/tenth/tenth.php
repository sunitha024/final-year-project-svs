...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">10th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $tena ?></h5></td>
               <td><h5><?php echo $tenb ?></h5></td>
               <td><h5><?php echo $tenc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $tend ?></h5></td>
               <td><h5><?php echo $tene ?></h5></td>
               <td><h5><?php echo $tenf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $teng ?></h5></td>
               ...
               <td><a href="delete.php?tenA=<?php echo $tena ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
