...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">9th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $nina ?></h5></td>
               <td><h5><?php echo $ninb ?></h5></td>
               <td><h5><?php echo $ninc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $nind ?></h5></td>
               <td><h5><?php echo $nine ?></h5></td>
               <td><h5><?php echo $ninf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $ning ?></h5></td>
               <td><h5><?php echo $ninh ?></h5></td>
               <td><h5><?php echo $nini ?></h5></td>
               <td><h5><?php echo $ninj ?></h5></td>
               <td><h5><?php echo $ninl ?></h5></td>


               <td><a href="update.php?ninA=<?php echo $nina ?>"><button class="btn btn-primary text-xl p-2">EDIT</button></a></td>
               <td><a href="delete.php?ninA=<?php echo $nina ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
