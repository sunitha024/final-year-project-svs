...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">8th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $eigtha ?></h5></td>
               <td><h5><?php echo $eigthb ?></h5></td>
               <td><h5><?php echo $eigthc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $eigthd ?></h5></td>
               <td><h5><?php echo $eigthe ?></h5></td>
               <td><h5><?php echo $eigthf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $eigthg ?></h5></td>
               <td><h5><?php echo $eigthh ?></h5></td>
               <td><h5><?php echo $eigthi ?></h5></td>
               <td><h5><?php echo $eigthj ?></h5></td>
               <td><h5><?php echo $eigthl ?></h5></td>


               <td><a href="update.php?eigthA=<?php echo $eigtha ?>"><button class="btn btn-primary text-xl p-2">EDIT</button></a></td>
               <td><a href="delete.php?eigthA=<?php echo $eigtha ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
