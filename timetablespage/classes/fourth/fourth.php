...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">4th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $fourtha ?></h5></td>
               <td><h5><?php echo $fourthb ?></h5></td>
               <td><h5><?php echo $fourthc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $fourthd ?></h5></td>
               <td><h5><?php echo $fourthe ?></h5></td>
               <td><h5><?php echo $fourthf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $fourthg ?></h5></td>
               <td><h5><?php echo $fourthh ?></h5></td>
               <td><h5><?php echo $fourthi ?></h5></td>
               <td><h5><?php echo $fourthj ?></h5></td>
               <td><h5><?php echo $fourthl ?></h5></td>


               <td><a href="update.php?fourthA=<?php echo $fourtha ?>"><button class="btn btn-primary text-xl p-2">EDIT</button></a></td>
               <td><a href="delete.php?fourthA=<?php echo $fourtha ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
