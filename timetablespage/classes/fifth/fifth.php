...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">5th CLASS TIMETABLE</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      ?>
          <tr>
               <td class="font-semibold italic"><h5><?php echo $fiftha ?></h5></td>
               <td><h5><?php echo $fifthb ?></h5></td>
               <td><h5><?php echo $fifthc ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $fifthd ?></h5></td>
               <td><h5><?php echo $fifthe ?></h5></td>
               <td><h5><?php echo $fifthf ?></h5></td>
               <td class="font-extrabold italic"><h5><?php echo $fifthg ?></h5></td>
               <td><h5><?php echo $fifthh ?></h5></td>
               <td><h5><?php echo $fifthi ?></h5></td>
               <td><h5><?php echo $fifthj ?></h5></td>
               <td><h5><?php echo $fifthl ?></h5></td>


               <td><a href="update.php?fifthA=<?php echo $fiftha ?>"><button class="btn btn-primary text-xl p-2">EDIT</button></a></td>
               <td><a href="delete.php?fifthA=<?php echo $fiftha ?>"><button class="btn btn-danger text-xl p-2">DELETE</button></a></td>
          </tr>
      <?php
        }
      }
