...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">8th Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    <!-- <button class="ml-20 mt-8 bg-violet-400 text-2xl font-semibold p-3 w-40 md:ml-[25%] rounded-md hover:bg-emerald-600  text-zinc-100" >
        ...
        <div class="flex gap-4 ml-20">
          ...
          <form method="POST" action="eigth.php">

            <input type="search" placeholder="Enter ID" name="eigthB"
    ...
    <table id="example" class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['eigthB']))
      {
        $eigthb = (int) $_POST['eigthB'];
        $query = "SELECT *from eigthr where TEIGTHB = $eigthb";
      }
      else
      {
      $query = "SELECT *from eigthr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $eigtha ?></h5></td>
               <td class="font-bold text-violet-400"><h5><?php echo $eigthb ?></h5></td>
               <td><h5><?php echo $eigthc ?></h5></td>
               <td><h5><?php echo $eigthd ?></h5></td>
               <td><h5><?php echo $eigthe ?></h5></td>
               <td><h5><?php echo (int) $eigthf = ((int) $eigthd + (int) $eigthe) ?></h5></td>
               <td><h5><?php echo $eigthg ?></h5></td>
               <td><h5><?php echo $eigthh ?></h5></td>
               <td><h5><?php echo (int) $eigthi = ((int) $eigthg + (int) $eigthh) ?></h5></td>
               <td><h5><?php echo $eigthj ?></h5></td>
               <td><h5><?php echo $eigthk ?></h5></td>
               <td><h5><?php echo $eigthl ?></h5></td>
               <td><h5><?php echo (int) $eigthm = ((int) $eigthk + (int) $eigthl) ?></h5></td>
               <td><h5><?php echo $eigthn ?></h5></td>
               <td><h5><?php echo $eigtho ?></h5></td>
               <td><h5><?php echo (int) $eigthp = ((int) $eigthn + (int) $eigtho) ?></h5></td>
               <td><h5><?php echo $eigthq ?></h5></td>
               <td><h5><?php echo (int) $eigths = ((int) $eigthf + (int) $eigthi + (int) $eigthj + (int) $eigthm + (int) $eigthp + (int) $eigthq ) ?></h5></td>
               <td><h5><?php echo (float) $eigthz = ((int) $eigths/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?eigthA=<?php echo $eigtha ?>">
            ...
            <td>
              <a href="delete.php?eigthA=<?php echo $eigtha ?>">
