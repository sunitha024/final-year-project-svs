...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">1st Marks Report</h1><br>
  ...
  <div class="container overflow-scroll ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="first.php">
            ...
            <input type="search" placeholder="Enter ID" name="firstB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['firstB']))
      {
        $firstb = (int) $_POST['firstB'];
        $query = "SELECT *from firstr where FIRSTB = $firstb";
      }
      else
      {
      $query = "SELECT *from firstr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $firsta ?></h5></td>
               <td class="font-bold text-green-400"><h5><?php echo $firstb ?></h5></td>
               <td class="font-bold"><h5><?php echo $firstc ?></h5></td>
               <td><h5><?php echo $firstd ?></h5></td>
               <td><h5><?php echo $firste ?></h5></td>
               <td><h5><?php echo  (int) $firstf = ((int) $firstd + (int) $firste) ?> </h5></td>
               <td><h5><?php echo $firstg ?></h5></td>
               <td><h5><?php echo $firsth ?></h5></td>
               <td><h5><?php echo (int) $firsti = ((int) $firstg + (int) $firsth) ?></h5></td>
               <td><h5><?php echo $firstj ?></h5></td>
               <td><h5><?php echo $firstk ?></h5></td>
               <td><h5><?php echo $firstl ?></h5></td>
               <td><h5><?php echo (int) $firstm = ((int) $firstk + (int) $firstl) ?></h5></td>
               <td><h5><?php echo $firstn ?></h5></td>
               <td><h5><?php echo $firsto ?></h5></td>
               <td><h5><?php echo (int) $firstp = ((int) $firstn + (int) $firsto) ?></h5></td>
               <td><h5><?php echo $firstq ?></h5></td>
               <td><h5><?php echo (int) $firsts = ((int) $firstnf + (int) $firsti + (int) $firstj + (int) $firstm + (int) $firstp + (int) $firstq ) ?></h5></td>
               <td><h5><?php echo (float) $firstz = ((int) $firsts/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?firstA=<?php echo $firsta ?>">
            ...
            <td>
              <a href="delete.php?firstA=<?php echo $firsta ?>">
