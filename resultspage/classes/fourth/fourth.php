...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">4th Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="fourth.php">
            ...
            <input type="search" placeholder="Enter ID" name="fourB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['fourB']))
      {
        $fourb = (int) $_POST['fourB'];
        $query = "SELECT *from fourthr where FOURB = $fourb";
      }
      else
      {
      $query = "SELECT *from fourthr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $foura ?></h5></td>
               <td class="font-bold text-green-400"><h5><?php echo $fourb ?></h5></td>
               <td class="font-bold"><h5><?php echo $fourc ?></h5></td>
               <td><h5><?php echo $fourd ?></h5></td>
               <td><h5><?php echo $foure ?></h5></td>
               <td><h5><?php echo (int) $fourf = ((int) $fourd + (int) $foure) ?> </h5></td>
               <td><h5><?php echo $fourg ?></h5></td>
               <td><h5><?php echo $fourh ?></h5></td>
               <td><h5><?php echo (int) $fouri = ((int) $fourg + (int) $fourh) ?></h5></td>
               <td><h5><?php echo $fourj ?></h5></td>
               <td><h5><?php echo $fourk ?></h5></td>
               <td><h5><?php echo $fourl ?></h5></td>
               <td><h5><?php echo (int) $fourm = ((int) $fourk + (int) $fourl) ?></h5></td>
               <td><h5><?php echo $fourn ?></h5></td>
               <td><h5><?php echo $fouro ?></h5></td>
               <td><h5><?php echo (int) $fourp = ((int) $fourn + (int) $fouro) ?></h5></td>
               <td><h5><?php echo $fourq ?></h5></td>
               <td><h5><?php echo (int) $fours = ((int) $fourf + (int) $fouri + (int) $fourj + (int) $fourm + (int) $fourp + (int) $fourq ) ?></h5></td>
               <td><h5><?php echo (float) $fourz = ((int) $fours/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?fourA=<?php echo $foura ?>">
            ...
            <td>
              <a href="delete.php?fourA=<?php echo $foura ?>">
