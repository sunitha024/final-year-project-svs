...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">3rd Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="third.php">
            ...
            <input type="search" placeholder="Enter ID" name="thirdB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['thirdB']))
      {
        $thirdb = (int) $_POST['thirdB'];
        $query = "SELECT *from thirdr where THIRDB = $thirdb";
      }
      else
      {
      $query = "SELECT *from thirdr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $thirda ?></h5></td>
               <td class="font-bold text-green-400"><h5><?php echo $thirdb ?></h5></td>
               <td class="font-bold"><h5><?php echo $thirdc ?></h5></td>
               <td><h5><?php echo $thirdd ?></h5></td>
               <td><h5><?php echo $thirde ?></h5></td>
               <td><h5><?php echo(int) $thirdf = ((int) $thirdd + (int) $thirde) ?> </h5></td>
               <td><h5><?php echo $thirdg ?></h5></td>
               <td><h5><?php echo $thirdh ?></h5></td>
               <td><h5><?php echo (int) $thirdi = ((int) $thirdg + (int) $thirdh) ?></h5></td>
               <td><h5><?php echo $thirdj ?></h5></td>
               <td><h5><?php echo $thirdk ?></h5></td>
               <td><h5><?php echo $thirdl ?></h5></td>
               <td><h5><?php echo (int) $thirdm = ((int) $thirdk + (int) $thirdl) ?></h5></td>
               <td><h5><?php echo $thirdn ?></h5></td>
               <td><h5><?php echo $thirdo ?></h5></td>
               <td><h5><?php echo (int) $thirdp = ((int) $thirdn + (int) $thirdo) ?></h5></td>
               <td><h5><?php echo $thirdq ?></h5></td>
               <td><h5><?php echo (int) $thirds = ((int) $thirdf + (int) $thirdi + (int) $thirdj + (int) $thirdm + (int) $thirdp + (int) $thirdq ) ?></h5></td>
               <td><h5><?php echo (float) $thirdz = ((int) $thirds/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?thirdA=<?php echo $thirda ?>">
            ...
            <td>
              <a href="delete.php?thirdA=<?php echo $thirda ?>">
