...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">2nd Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="second.php">
            ...
            <input type="search" placeholder="Enter ID" name="secondB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['secondB']))
      {
        $secondb = (int) $_POST['secondB'];
        $query = "SELECT *from secondr where SECONDB = $secondb";
      }
      else
      {
      $query = "SELECT *from secondr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $seconda ?></h5></td>
               <td class="font-bold text-green-400"><h5><?php echo $secondb ?></h5></td>
               <td class="font-bold"><h5><?php echo $secondc ?></h5></td>
               <td><h5><?php echo $secondd ?></h5></td>
               <td><h5><?php echo $seconde ?></h5></td>
               <td><h5><?php echo (int) $secondf = ((int) $tend + (int) $seconde) ?> </h5></td>
               <td><h5><?php echo $secondg ?></h5></td>
               <td><h5><?php echo $secondh ?></h5></td>
               <td><h5><?php echo (int) $secondi = ((int) $secondg + (int) $secondh) ?></h5></td>
               <td><h5><?php echo $secondj ?></h5></td>
               <td><h5><?php echo $secondk ?></h5></td>
               <td><h5><?php echo $secondl ?></h5></td>
               <td><h5><?php echo (int) $secondm = ((int) $secondk + (int) $secondl) ?></h5></td>
               <td><h5><?php echo $secondn ?></h5></td>
               <td><h5><?php echo $secondo ?></h5></td>
               <td><h5><?php echo (int) $secondp = ((int) $secondn + (int) $secondo) ?></h5></td>
               <td><h5><?php echo $secondq ?></h5></td>
               <td><h5><?php echo (int) $seconds = ((int) $secondf + (int) $secondi + (int) $secondj + (int) $secondm + (int) $secondp + (int) $secondq ) ?></h5></td>
               <td><h5><?php echo (float) $secondz = ((int) $seconds/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?secondA=<?php echo $seconda ?>">
            ...
            <td>
              <a href="delete.php?secondA=<?php echo $seconda ?>">
