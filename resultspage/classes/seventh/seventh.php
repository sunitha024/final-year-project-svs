...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">7th Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['sevenB']))
      {
        $sevenb = (int) $_POST['sevenB'];
        $query = "SELECT *from sevenr where SEVENB = $sevenb";
      }
      else
      {
      $query = "SELECT *from sevenr";
      }
      ...
      ?>
          <tr>
               ...
               <td class="font-bold"><h5><?php echo $sevena ?></h5></td>
               <td class="font-bold text-green-400"><h5><?php echo $sevenb ?></h5></td>
               <td class="font-bold"><h5><?php echo $sevenc ?></h5></td>
               <td><h5><?php echo $sevend ?></h5></td>
               <td><h5><?php echo $sevene ?></h5></td>
               <td><h5><?php echo (int) $sevenf = ((int) $sevend + (int) $sevene) ?></h5></td>
               <td><h5><?php echo $seveng ?></h5></td>
               <td><h5><?php echo $sevenh ?></h5></td>
               <td><h5><?php echo (int) $seveni = ((int) $seveng + (int) $sevenh) ?></h5></td>
               <td><h5><?php echo $sevenj ?></h5></td>
               <td><h5><?php echo $sevenk ?></h5></td>
               <td><h5><?php echo $sevenl ?></h5></td>
               <td><h5><?php echo (int) $sevenm = ((int) $sevenk + (int) $sevenl) ?></h5></td>
               <td><h5><?php echo $sevenn ?></h5></td>
               <td><h5><?php echo $seveno ?></h5></td>
               <td><h5><?php echo (int) $sevenp = ((int) $sevenn + (int) $seveno) ?></h5></td>
               <td><h5><?php echo $sevenq ?></h5></td>
               <td><h5><?php echo (int) $sevens = ((int) $sevenf + (int) $seveni + (int) $sevenj + (int) $sevenm + (int) $sevenp + (int) $sevenq ) ?></h5></td>
               <td><h5><?php echo (float) $sevenz = ((int) $sevens/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?sevenA=<?php echo $sevena ?>">
            ...
            <td>
              <a href="delete.php?sevenA=<?php echo $sevena ?>">
