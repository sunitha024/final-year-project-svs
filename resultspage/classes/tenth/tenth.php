...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-6">10th Marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <br>
    <table id="example" class="table table-hover  mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      {
        $tenb = (int) $_POST['tenB'];
        $query = "SELECT *from tenr where TENB = $tenb";
      }
      else
      {
      ...
      if ($stmt) {
        ...
        while (($row = oci_fetch_array($stmt))) {
          ...
          <tr>
            ...
            <td>
              <h5>
                <?php echo (int) $tenf = ((int) $tend + (int) $tene) ?>
              </h5>
            </td>
            <td>
              <h5>
            ...
            <td>
              <h5>
                <?php echo (int) $teni = ((int) $teng + (int) $tenh) ?>
              </h5>
            </td>
            <td>
              <h5>
            ...
            <td>
              <h5>
                <?php echo (int) $tenm = ((int) $tenk + (int) $tenl) ?>
              </h5>
            </td>
            <td>
              <h5>
            ...
            <td>
              <h5>
                <?php echo (int) $tenp = ((int) $tenn + (int) $teno) ?>
              </h5>
            </td>
            <td>
              <h5>
            ...
            <td>
              <h5>
                <?php echo (int) $tens = ((int) $tenf + (int) $teni + (int) $tenj + (int) $tenm + (int) $tenp + (int) $tenq ) ?>
              </h5>
            </td>
            <td>
              <h5>
                <?php echo (float) $tenz = ((int) $tens/400) *100 ?>%
              </h5>
            </td>
