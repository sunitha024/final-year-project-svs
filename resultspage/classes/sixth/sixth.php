...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">6th marks Report</h1><br>
  ...
  <div class="container overflow-scroll  ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="sixth.php">
            ...
            <input type="search" placeholder="Enter ID" name="sixB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      {
        $sixb = (int) $_POST['sixB'];
        $query = "SELECT *from sixr where SIXB = $sixb";
      }
      else
      {
      ...
      ?>
          <tr>
               ...
               <td class="font-bold text-violet-400"><h5><?php echo $sixb ?></h5></td>
               <td><h5><?php echo $sixc ?></h5></td>
               <td><h5><?php echo $sixd ?></h5></td>
               <td><h5><?php echo $sixe ?></h5></td>
               <td><h5><?php echo (int) $sixf = ((int) $sixd + (int) $sixe) ?></h5></td>
               <td><h5><?php echo $sixg ?></h5></td>
               <td><h5><?php echo $sixh ?></h5></td>
               <td><h5><?php echo (int) $sixi = ((int) $sixg + (int) $sixh) ?></h5></td>
               <td><h5><?php echo $sixj ?></h5></td>
               <td><h5><?php echo $sixk ?></h5></td>
               <td><h5><?php echo $sixl ?></h5></td>
               <td><h5><?php echo (int) $sixm = ((int) $sixk + (int) $sixl) ?></h5></td>
               <td><h5><?php echo $sixn ?></h5></td>
               <td><h5><?php echo $sixo ?></h5></td>
               <td><h5><?php echo (int) $sixp = ((int) $sixn + (int) $sixo) ?></h5></td>
               <td><h5><?php echo $sixq ?></h5></td>
               <td><h5><?php echo (int) $sixs = ((int) $sixf + (int) $sixi + (int) $sixj + (int) $sixm + (int) $sixp + (int) $sixq ) ?></h5></td>
               <td><h5><?php echo (float) $sixz = ((int) $sixs/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?sixA=<?php echo $sixa ?>">
            ...
            <td>
              <a href="delete.php?sixA=<?php echo $sixa ?>">
