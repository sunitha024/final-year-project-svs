  ...
  <div class="container overflow-scroll  ">
    ...
    <a href="insert.php">
          ...
          <form method="POST" action="fifth.php">
            ...
            <input type="search" placeholder="Enter ID" name="fiveB"
    ...
    <table class="mt-2 table table-hover justify-center text-center text-xs md:text-xl ">
      ...
      <?php
      include "connect.php";
      if(isset($_POST['fiveB']))
      {
        $fiveb = (int) $_POST['fiveB'];
        $query = "SELECT *from fiver where FIVEB = $fiveb";
      }
      else
      {
      ...
      ?>
          <tr>
               ...
               <td class="font-bold text-violet-400"><h5><?php echo $fiveb ?></h5></td>
               <td Class="font-bold"><h5><?php echo $fivec ?></h5></td>
               <td><h5><?php echo $fived ?></h5></td>
               <td><h5><?php echo $fivee ?></h5></td>
               <td><h5><?php echo (int) $fivef = ((int) $fived + (int) $fivee) ?> </h5></td>
               <td><h5><?php echo $fiveg ?></h5></td>
               <td><h5><?php echo $fiveh ?></h5></td>
               <td><h5><?php echo (int) $fivei = ((int) $fiveg + (int) $fiveh) ?></h5></td>
               <td><h5><?php echo $fivej ?></h5></td>
               <td><h5><?php echo $fivek ?></h5></td>
               <td><h5><?php echo $fivel ?></h5></td>
               <td><h5><?php echo (int) $fivem = ((int) $fivek + (int) $fivel) ?></h5></td>
               <td><h5><?php echo $fiven ?></h5></td>
               <td><h5><?php echo $fiveo ?></h5></td>
               <td><h5><?php echo (int) $fivep = ((int) $fiven + (int) $fiveo) ?></h5></td>
               <td><h5><?php echo $fiveq ?></h5></td>
               <td><h5><?php echo (int) $fives = ((int) $fivef + (int) $fivei + (int) $fivej + (int) $fivem + (int) $fivep + (int) $fiveq ) ?></h5></td>
               <td><h5><?php echo (float) $fivez = ((int) $fives/400) *100 ?>%</h5></td>
		


               <td class="gap-0">
              <a href="update.php?fiveA=<?php echo $fivea ?>">
            ...
            <td>
              <a href="delete.php?fiveA=<?php echo $fivea ?>">
