...
<body>
	...
	<div>
		<div class="text-center text-4xl text-pink-900 mt-6 font-bold gap-1">Sree vidya school FEE Payment</div>
		<div class="text-center text-3xl text-blue-900 font-bold">pay through scan the Qr Code </div>

		<div class="3xs:ml-[3%] 2xs:ml-[11%] xs:ml-[16%] md:ml-[30%] lg:ml-[42%] mt-8"><img src="QRcode.png" /></div>
	</div>

	<!-- <a href="rupee.png">download qr</a> -->
</body>
