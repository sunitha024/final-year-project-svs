...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">4th Student Details</h1><br>
         ...
         <div class="flex 3xs:gap-2 2xs:gap-4">
          ...
          <form method="POST" action="fourth.php">
            ...
            <input type="search" placeholder="Enter ID" name="fourB"
              class="search focus-none border-b h-12 w-[40%]  border-b-violet-900 text-black rounded-md text-center text-lg font-bold">
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      if (isset($_POST['fourB'])) 
      {
        ...
        $query = "SELECT *from fourthsd where fourB=$fourb";
      } 
      else 
      {
        $query = "SELECT *from fourthsd ";
      }
