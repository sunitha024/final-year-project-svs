...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO fourthsd (FOURA,FOURB,FOURC,FOURD,FOURE,FOURF,FOURG,FOURH) VALUES('$foura',$fourb,'$fourc','$fourd','$foure','$fourf','$fourg','$fourh')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-black font-bold" placeholder="Enter S.no" name="foura">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control text-black font-bold" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="fourb">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-black font-bold" placeholder="Enter the Area" name="fourh">
