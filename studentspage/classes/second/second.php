...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">3rd Student Details</h1><br>
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      if (isset($_POST['secondB'])) 
      {
        ...
        $query = "SELECT *from secondsd where SECONDB=$secondb";
      } 
      else 
      {
        $query = "SELECT *from secondsd ";
      }
