...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO secondsd (SECONDA,SECONDB,SECONDC,SECONDD,SECONDE,SECONDF,SECONDG,SECONDH) VALUES('$seconda',$secondb,'$secondc','$secondd','$seconde','$secondf','$secondg','$secondh')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter S.no" name="seconda">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control font-bold text-black" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="secondb">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter the Area" name="secondh">
