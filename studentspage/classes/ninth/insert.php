...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO ninthsd (NINEA,NINEB,NINEC,NINED,NINEE,NINEF,NINEG,NINEH) VALUES('$ninea',$nineb,'$ninec','$nined','$ninee','$ninef','$nineg','$nineh')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter S.no" name="ninea">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control font-bold text-black" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="nineb">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control font-bold text-black" placeholder="Enter the Date of Birth" name="ninee">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter the Area" name="nineh">
