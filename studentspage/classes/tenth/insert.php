...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tenthsd (TENA,TENB,TENC,TEND,TENE,TENF,TENG,TENH) VALUES('$tena',$tenb,'$tenc','$tend','$tene','$tenf','$teng','$tenh')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter S.no" name="tena">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control font-bold text-black" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="tenb">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter the Area" name="tenh">
