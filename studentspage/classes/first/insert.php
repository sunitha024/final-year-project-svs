...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO firstsd (FIRSTA,FIRSTB,FIRSTC,FIRSTD,FIRSTE,FIRSTF,FIRSTG,FIRSTH) VALUES('$firsta',$firstb,'$firstc','$firstd','$firste','$firstf','$firstg','$firsth')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter S.no" name="firsta">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control font-bold text-black" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="firstb">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter the Area" name="firsth">
