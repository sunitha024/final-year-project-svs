...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">7th Student Details</h1><br>
      ...
      <div class="md:flex gap-4 2xs:ml-4 xs:ml-10 lg:ml-20">
         ...
         <div class="flex 3xs:gap-2 2xs:gap-4">
          ...
          <form method="POST" action="seventh.php">
            ...
            <input type="search" placeholder="Enter ID" name="sevenB"
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      if (isset($_POST['sevenB'])) 
      {
        ...
        $query = "SELECT *from seventhsd where SEVENB=$sevenb";
      } 
      else 
      {
        $query = "SELECT *from seventhsd ";
      }
