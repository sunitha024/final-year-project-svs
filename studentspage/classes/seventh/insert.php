...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO seventhsd (SEVENA,SEVENB,SEVENC,SEVEND,SEVENE,SEVENF,SEVENG,SEVENH) VALUES('$sevena',$sevenb,'$sevenc','$sevend','$sevene','$sevenf','$seveng','$sevenh')";
    ...
    <div class="container my-5 ">
        ...
        <form method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-black font-bold" placeholder="Enter S.no" name="sevena">
            </div>
            <div class="form-group">
                <label>
                    <h5 class="text-xl">Enter the Id</h5>
                </label>
                <input type="text" class="form-control text-black font-bold" placeholder="Enter ID" pattern="[^a-zA-Z]+" name="sevenb">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control font-bold text-black" placeholder="Enter the Area" name="sevenh">
