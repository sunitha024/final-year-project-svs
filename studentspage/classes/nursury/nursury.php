...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">Nursury Student Details</h1><br>
    ...
    <div class="container overflow-scroll lg:overflow-hidden">
      <div class="md:flex gap-4 2xs:ml-4 xs:ml-10 lg:ml-20">
         ...
         <div class="flex 3xs:gap-2 2xs:gap-4">
          ...
          <form method="POST" action="nursury.php">

            
            <input type="search" placeholder="Enter ID" name="nursuryB"
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      include "connect.php";
      if (isset($_POST['nursuryB'])) 
      {
        $nursuryb = (int) $_POST['nursuryB'];
        $query = "SELECT *from nursurysd where NURSURYB=$nursuryb";
      } 
      else 
      {
        $query = "SELECT *from nursurysd ";
      }
      ...
      if ($stmt) {
        while (($row = oci_fetch_array($stmt))) {
          ...
          <tr>
            ...
            <td class="gap-0">
              <a href="update.php?nursuryA=<?php echo $nursurya ?>">
            ...
            <td>
              <a href="delete.php?nursuryA=<?php echo $nursurya ?>">
