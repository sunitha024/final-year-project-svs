...
<body>
	...
	<div>
		<label for="file-upload"
			class=" file-upload flex items-center justify-center font-sm mt-6 ml-36 2xs:ml-52 xs:ml-60 md:ml-[65%] md:h-12 md:w-60 justify-items-end bg-violet-900 md:text-2xl rounded-md hover:bg-emerald-600  text-zinc-100 absolute ">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
				stroke="currentColor" class="w-7 h-7 inline">
				<path stroke-linecap="round" stroke-linejoin="round"
					d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
			</svg>

			<h1 class=" inline text-center pointer">&nbsp;Upload File</h1>
