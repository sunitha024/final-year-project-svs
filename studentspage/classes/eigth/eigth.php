...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">8th Student Details</h1><br>
    ...
    <table id="example" class="table table-hover overflow-scroll lg:overflow:hidden mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      {
        $eigthb = (int) $_POST['tenB'];
        $query = "SELECT *from eigthsd where EIGTHB=$eigthb";
      } 
      else 
      {
        $query = "SELECT *from eigthsd ";
      }
