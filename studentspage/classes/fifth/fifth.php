...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">5th Student Details</h1><br>
      ...
      <div class="md:flex gap-4 2xs:ml-4 xs:ml-10 lg:ml-20">
         ...
         <div class="flex 3xs:gap-2 2xs:gap-4">
          ...
          <form method="POST" action="fifth.php">
            ...
            <input type="search" placeholder="Enter ID" name="fifthB"
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      include "connect.php";
      if (isset($_POST['fifthB'])) 
      {
        $fifthb = (int) $_POST['fifthB'];
        $query = "SELECT *from fifthsd where FIFTHB=$fifthb";
      } 
      else 
      {
        $query = "SELECT *from fifthsd ";
      }
      ...
      if ($stmt) {
        while (($row = oci_fetch_array($stmt))) {
          ...
          <tr>
            ...
            <td class="gap-0">
              <a href="update.php?fifthA=<?php echo $fiftha ?>">
            ...
            <td>
              <a href="delete.php?fifthA=<?php echo $fiftha ?>">
