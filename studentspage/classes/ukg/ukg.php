...
<body>
  ...
  <h1 class="text-center text-2xl font-bold italic mt-10">ukg Student Details</h1><br>
    ...
    <div class="container overflow-scroll lg:overflow-hidden">
      <div class="md:flex gap-4 2xs:ml-4 xs:ml-10 lg:ml-20">
         ...
         <div class="flex 3xs:gap-2 2xs:gap-4">
          ...
          <form method="POST" action="ukg.php">

            
            <input type="search" placeholder="Enter ID" name="ukgB"
    ...
    <table id="example" class="table table-hover overflow:scroll mt-2  justify-center text-center text-xs md:text-xl ">
      ...
      {
        $ukgb = (int) $_POST['ukgB'];
        $query = "SELECT *from ukgsd where UKGB=$ukgb";
      } 
      else 
      {
        $query = "SELECT *from ukgsd ";
      }
      ...
      if ($stmt) {
        while (($row = oci_fetch_array($stmt))) {
          ...
          <tr>
            ...
            <td class="gap-0">
              <a href="update.php?ukgA=<?php echo $ukga ?>">
            ...
            <td>
              <a href="delete.php?ukgA=<?php echo $ukga ?>">
